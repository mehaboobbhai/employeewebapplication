...
public class InsertEmpController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		EmployeeAddressInfo eAddrBean = new EmployeeAddressInfo();
		...
		EmployeeCareerInfo eCareBean = new EmployeeCareerInfo();
		...
		EmployeeOtherInfo eOtherBean = new EmployeeOtherInfo();
		/*eOtherBean.setDateOfBirth((req.getParameter("e_dob")));*/
		eOtherBean.setPhoneNumber(Long.parseLong(req.getParameter("e_phone")));
